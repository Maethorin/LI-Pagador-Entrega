...
import unittest
import mock
from pagador_retirada import entidades
...
class EntregaConfiguracaoMeioPagamento(unittest.TestCase):
    ...
    @mock.patch('pagador_retirada.entidades.ConfiguracaoMeioPagamento.preencher_gateway', mock.MagicMock())
    ...
    @mock.patch('pagador_retirada.entidades.ConfiguracaoMeioPagamento.preencher_gateway', autospec=True)
    ...
    def test_deve_definir_formulario_na_inicializacao(self):
        configuracao = entidades.ConfiguracaoMeioPagamento(234)
        configuracao.formulario.should.be.a('pagador_retirada.cadastro.FormularioRetirada')
